...
}else(console.log(`I recently ate some ${food}!`))
...
var vegetables = ["bell peppers", "brussel sprouts", "green beans", "broccoli", "peas"]
...
fruits = ["straw berry", "blue berry", "pear", "pineapple", "rambutan", "orange", "apple"]
...
var groceryStore = {
    ...
    hasFood: true,
    hasAisles: 24,
    deparments: ["pharmacy", "deli", "bakery"]
}
